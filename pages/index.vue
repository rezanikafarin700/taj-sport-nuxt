        ...
        <section class="wrapper">
          <div class="article space">
            ...
            <div class="article__text">
              <h2 class="title-items dastnevis">کارگاه تاج اسپرت</h2>
              <br />
              <div class="article__intro">
                <p class="start-intro__text para">
                  ما در این مجوعه سعی داریم تا با تولید محصولاتی با کیفیت ساعاتی
                  پر نشاط سر گرم کننده همراه با خاطراتی به یاد ماندنی را برای
                  شما مشتریان عزیز فراهم کنیم و با تولید محصولات با کیفیت و
                  متنوع در پی کسب رضایت شما دوستان گرامی هستیم
                </p>
              </div>
            </div>
